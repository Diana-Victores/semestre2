...
DefaultTableModel modeloC=new DefaultTableModel();
    ...
    private void initComponents() {
        ...
        Dividir.setText("Dividir Matrices ");
        ...
        jButton1.setText("Resta de Matrices");
        ...
        jButton2.setText("Multiplicacion de Matrices");
...
private void genC(int fil,int col){
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        int i,j,r;
        int eli=matrizA.getRowCount();
        int eli2=matrizB.getRowCount();
        int eli3=matrizResul.getRowCount();
        for(i=eli-1;i>=0;i--){
             modeloA.removeRow(i);
        }
        for(j=eli2-1;j>=0;j--){
